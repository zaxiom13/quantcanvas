...
export const ReferencePanel: React.FC = React.memo(() => {
    ...
    <div className="h-full flex flex-col overflow-hidden text-[#e5eef2]">
      <div className="flex items-center justify-between p-3 border-b border-white/10 bg-gradient-to-r from-white/5 to-transparent">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <CardTitle className="text-base font-semibold text-[#e5eef2]">Q/KDB+ Basics</CardTitle>
      ...
      <div className="flex-shrink-0 p-3 pb-2 border-b border-white/10 bg-white/5">
        <div className="flex items-center space-x-3">
          ...
          {(searchTerm || selectedCategory !== 'all') && (
            <Button variant="outline" size="sm" onClick={clearSearch} className="hover:border-neon-500/40 hover:bg-white/5">
              Clear
            </Button>
          )}
        </div>
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="bg-[#0b0f10] rounded-md p-3 mb-2 border border-white/10">
                              <code className="text-sm font-mono text-[#e5eef2] whitespace-pre-wrap break-all">{item.q}</code>
                            </div>
